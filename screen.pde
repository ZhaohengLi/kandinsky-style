class Screen {
  ...
  Screen() {
    this.cd = new CD(300, 300, 120);

    this.lineList = new ArrayList();
    this.lineList.add(new Line(1, 620, 700, 300));
    this.lineList.add(new Line(2, 900, 500, 200));

    this.dotList = new ArrayList();
    this.dotList.add(new Dot(101, 150, 600, 40));
    this.dotList.add(new Dot(102, 400, 570, 90));
    this.dotList.add(new Dot(101, 750, 450, 170));
    this.dotList.add(new Dot(102, 1300, 500, 160));
    //this.dotList.add(new Dot(101, 600, 600, 50));
    //this.dotList.add(new Dot(201, 600, 200, 80));

    this.gridList = new ArrayList();
    this.gridList.add(new Grid(1, 1300, 100, 200));
    this.gridList.add(new Grid(2, 1200, 760, 200));
    //this.gridList.add(new Grid(2, 400, 340, 200));
    //this.gridList.add(new Grid(1, 900, 300, 140));
    this.gridList.add(new Grid(3, 900, 300, 140));
